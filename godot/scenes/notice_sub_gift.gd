...
## The name of the user receiving the gift.
var user_name: String:
	get:
		if data.has("event") and \
				data["event"].has("recipient") and \
				data["event"]["recipient"].has("name"):
			return data["event"]["recipient"]["name"]
		else:
			return ""
